...
df_ratings_by_demo = df_wide %>%
  inner_join(df_items) %>%
  inner_join(df_item_means)
nrow(df_ratings_by_demo)

write.csv(df_ratings_by_demo,
          "../../data/processed/human/sawc_relatedness_by_demographic.csv")
